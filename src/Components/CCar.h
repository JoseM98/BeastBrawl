...
public:
    ...
    float incrementWheelRotation = 25;  // velocidad por iteracion que se gira la rueda
    float decrementWheelRotation = 27;  // velocidad por iteracion que se recupera la rueda
