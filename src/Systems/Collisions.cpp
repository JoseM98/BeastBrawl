...
bool Collisions::Intersects(Entity* entity1,Entity* entity2){
    ...
    float e1MinX = cTransformableE1->positionNext.x - cDimensionsE1->width/2;
    float e1MinY = cTransformableE1->positionNext.y - cDimensionsE1->height/2;
    float e1MinZ = cTransformableE1->positionNext.z - cDimensionsE1->depth/2;
    float e1MaxX = cTransformableE1->positionNext.x + cDimensionsE1->width/2;
    float e1MaxY = cTransformableE1->positionNext.y + cDimensionsE1->height/2;
    float e1MaxZ = cTransformableE1->positionNext.z + cDimensionsE1->depth/2;

    float e2MinX = cTransformableE2->positionNext.x - cDimensionsE2->width/2;
    float e2MinY = cTransformableE2->positionNext.y - cDimensionsE2->height/2;
    float e2MinZ = cTransformableE2->positionNext.z - cDimensionsE2->depth/2;
    float e2MaxX = cTransformableE2->positionNext.x + cDimensionsE2->width/2;
    float e2MaxY = cTransformableE2->positionNext.y + cDimensionsE2->height/2;
    float e2MaxZ = cTransformableE2->positionNext.z + cDimensionsE2->depth/2;
