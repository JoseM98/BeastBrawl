...
class CLPhysics {
   public:
        ...
        //TODO: Si no se va a usar más, quitar.
   ...
   private:
        ...
        [[nodiscard]] double Angle2Vectors(const glm::vec3 &a, const glm::vec3 &b) const;
        //TODO: NO ESTA IMPLEMENTADA
        [[nodiscard]] glm::vec3 CalculateProyectPointRecta(const glm::vec3 &extrem1, const glm::vec3 &extrem2, const glm::vec3 &point_) const;
        [[nodiscard]] glm::vec3 CalculateVecDirCar(CTransformable &cTransformable) const;
